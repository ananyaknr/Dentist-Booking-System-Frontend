  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col space-y-4 rounded-lg w-full justify-center items-center pb-2">
        ...
        <input type="tel" name="tel" placeholder="Tel. (000-000-0000)" onChange={handleChange} className="border p-3 rounded-lg w-3/4 shadow-md" 
        required pattern="\d{3}-\d{3}-\d{4}" title="000-000-0000"/>
        ...
        <button type="submit" className="bg-blue-600 text-white p-2 rounded w-1/2 mt-11 hover:bg-blue-800 shadow-xl 
        hover:shadow-[0_10px_30px_rgba(0,0,0,0.3)] transition-all duration-100">Register</button>
      </form>
