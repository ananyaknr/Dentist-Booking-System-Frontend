...
//     return(
//         <div>
//             <div style={{margin:'20px', padding:"10px", display: "flex", flexDirection:"row",flexWrap:"wrap", justifyContent:"space-around", alignContent:"space-around"}}>
//                 { carResponse.data.map((carItem:CarItem)=>( 
//                     <Link href={`/car/${carItem.id}`} className='w-1/5'>
//                         <ProductCard  
//                             carName={carItem.model} imgSrc={carItem.picture}  
...
//                 <div key={car} onClick={()=>dispatchCompare({type:'remove', carName:car})}>{car}</div>
//             )}
